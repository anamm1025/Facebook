...
?></div>
        ...
        <div class="aboutwhitePanelLeft">
            <a href="#" class="black" id=overview">Overview</a> </br> </br> <a href="#" class="grey" id="work">Work and
                Education</a> </br> </br> <a href="#" class="grey" id="places">Places You've Lived</a> </br>
            </br> <a href="#" class="grey" id="contact">Contact and Basic Info</a> </br> </br> <a href="#"
                class="grey" id="family">Family and Relationships</a> </br> </br> <a href="#" class="grey" id="details">Details
                    About You</a> </br> </br> <a href="#" class="grey" id="life">Life Events</a>
        </div>
        <div class="aboutwhitePanelRight">
