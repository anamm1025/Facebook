...
?></div>
    ...
    <div class="photoswhitePanel" style="height:auto;margin-bottom:20px;">
...
$dp=$row["senderdp"];
 ...
 echo  "<a href='addFrnd.php?frndname=$nn &fname=$fn&lname=$ln&dp=$dp'" . " style='padding-top:0px;padding-right:10px;'>" . $row["senderfname"] ." " .$row["senderlname"] . " has sent you a frnd request" . ": " . "</a>" ;
  echo "</br><img  alt='Unable to View' class='avatar_img' width=180 height=150 src='" . $row["senderdp"] . "'>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp" ;
 echo  "<a href='ConfirmRequest.php?frndname=$nn&fname=$fn&lname=$ln&dp=$dp' style='font-size:12px;'>". "CONFIRM REQUEST " . "</br></br><br/></a>";
