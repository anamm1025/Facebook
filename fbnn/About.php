...
?></div>
        ...
        <div class="aboutPanel">
            <img src="images/about.png">&nbsp<a href="about.php" class="k"> About</a>

<a href="About2.php" style="color:grey;background-color:inherit;float:right;width:50px;height:20px;" id="editButton1" >Edit</a>
</div>
...
echo 	'<div style="text-align:center" class="editProfile">'. 'Gender: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $gender. '</div>';


echo 	'<div style="text-align:center" class="editProfile">'. 'Work as:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $work . '</div>';


echo 	'<div style="text-align:center" class="editProfile">'. 'Home Town:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'. $homeTown . '</div>';
...
echo 	'<div style="text-align:center" class="editProfile">'. 'Studies at:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $program . '</div>';

echo 	'<div style="text-align:center" class="editProfile">'. 'College:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $college . '</div>';

echo 	'<div style="text-align:center" class="editProfile">'.'High School:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $highSchool . '</div>';
...
echo 'Home Town:';
echo 	'<div style="text-align:center" class="editProfile">'. $city. ',' .$country.'</div>';
echo 'Current Place: ';
echo 	'<div style="text-align:center" class="editProfile">'. $city. ',' .$country.'</div>';

echo 	'Address:<div style="text-align:center" class="editProfile">'. '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $address .'</div>';
...
echo 	'<div style="text-align:center" class="editProfile">'. 'Gender:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $gender. '<br><br>'.'Religion: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$religion. '</div>';

echo 	'<div style="text-align:center" class="editProfile">'. 'Contact Number:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $contact . '</div>';

echo 	'<div style="text-align:center" class="editProfile">'. 'Date of Birth: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $day.'/'.$month.'/'.$year . '</div>';


echo 	'<div style="text-align:center" class="editProfile">'. 'About Me:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$aboutme . '</div>';
...
echo 	'<div style="text-align:center" class="editProfile">'.'Relationship Status:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$relationship. '</div>';

echo 	'<div style="text-align:center" class="editProfile">'.'Interested In:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$interested. '</div>';
...
echo 	'<div style="text-align:center" class="editProfile">'. 'Nick Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $nickname . '<br><br>';
echo 'Language:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$language.'</div>';

echo 	'<div style="text-align:center" class="editProfile">'. 'Arts: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $arts . '</div>';

echo 	'<div style="text-align:center" class="editProfile">'. 'Favourite Quotation: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $favQuote . '</div>';


echo 	'<div style="text-align:center" class="editProfile">'. 'Religious Views: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $relViews  . '</div>';
