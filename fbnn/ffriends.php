...
?></div>
    ...
    <div class="aboutPanel">
        <img src="images/photo.png">&nbsp<a href="ffriends.php" class="k"> Friends</a>
    </div>

    <div class="photoswhitePanel" style="height:auto;">
        
<?php 
$email=$_SESSION['friend'];
...
//echo "<div style='margin-left:300px;'>";
 echo  "<a href='addFrnd.php?frndname=$nn &fname=$fn&lname=$ln&dp=$dp'" . " style='padding-top:0px;padding-right:10px;float:left'>" . $row2["email1fname"] ." " .$row2["email1lname"] . ": " . "</a>" ;
