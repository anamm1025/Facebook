...
?></div>
    ...
    <div class="photoswhitePanel" style="height:auto;margin-bottom:20px;padding-left:150px;width:690px;">
...
$dp=$row["profImage"];
 ...
 echo  "<a href='addFrnd.php?frndname=$nn &fname=$fn&lname=$ln&dp=$dp'" . " style='padding-top:0px;padding-right:70px;'>" . $row["FirstName"] . " " . $row["LastName"].": " . "</a>" ;
  echo "<img  alt='Unable to View' class='avatar_img' width=180 height=150 src='" . $row["profImage"] . "'>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp" ;
 echo "<br/><br/>"; 
  }
